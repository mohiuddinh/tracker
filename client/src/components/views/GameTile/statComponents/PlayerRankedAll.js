...
function PlayerRankedAll(props) {

    const [playersRankedAll, setPlayerRankedAll] = useState([]);


 var playerRanked = (async () => {
  ...
  function showPlayerRankedAll() {
    return (
      <div>
        {playersRankedAll.map((data,id) => {
...
export default PlayerRankedAll;